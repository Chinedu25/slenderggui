              ...
              <div style={{ justifyContent: 'center', display: 'flex' }}>
                <div className="withdrawGuide">
                  <div style={{ marginTop: 12, display: 'flex' }}>
                    <img
                      className="withdrawalStatusImg"
                      src={HelpIcon}
                      alt=""
                    />
                    <span
                      style={{ alignSelf: 'center' }}
                      className="withdrawSubtitle"
                    >
                      How to Withdraw
                    </span>
                  </div>
                  <span style={{ width: 286 }} className="withdrawMessage">
                    To withdraw your earned robux, a Gamepass costing the exact
                    amount of robux you wish to withdraw is required. Detailed
                    instructions are available on our website and on our our
                    YouTube channel. Please contact us if you require additional
                    help.{' '}
                  </span>
                </div>
              </div>
            ...
            <div style={{ marginLeft: 8 }} className="withdrawContentBox">
              ...
              >
                {fakeWithdrawHistory.length > 0 ? (
                  fakeWithdrawHistory
                    .slice(
                      fakeWithdrawHistory.length - 4,
                      fakeWithdrawHistory.length
                    )
                    .map((data, key) => {
                      return (
                        //@ts-ignore
              ...
              <div
                style={{ marginTop: 24, flexDirection: 'row', display: 'flex' }}
              >
                <div>
                  <img
                    style={{

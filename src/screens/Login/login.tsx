      ...
      {isErrorUI ? (
        <div className="loginSection">
          <h4 className="loginFailed">
            Login failed. Please ensure that you have entered the username
            correctly and that you have a stable internet connection.
          </h4>
        ...
        <div className="loginSection">
          ...
          <div className="initialLoad">
            <div>
              <ClipLoader color={'#fff'} loading={initalLoad} size={25} />
            </div>
            <span className="initialLoadText">Loading</span>
          </div>
          <div>
            <h3 className="disclaimerText" style={{ marginTop: 81 }}>
              Please ensure your entered username is correct. We will not refund
              robux if withdrawn into an incorrect account.
            </h3>
          </div>
        </div>
      ) : logging ? (
        <div className="loginSection">
          ...
          <div className="initialLoad" style={{ marginTop: 51 }}>
            <div>
              <ClipLoader color={'#fff'} loading={logging} size={25} />
            </div>
        ...
        <div className="loginSection">
          <h4 className="slendergg">slender.gg</h4>
          <h3 className="loginMessage">
            Please enter your roblox username to start earning robux.
          </h3>
          <TextInput
            value={robUsername}
